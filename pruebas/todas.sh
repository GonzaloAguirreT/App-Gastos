#!/bin/bash
#
# Las trece pruebas, cada una con el modo de servidor que necesita.
#
#   sh pruebas/todas.sh
#
...
# Estas dos no necesitan navegador ni servidor: leen los .gs y comprueban que
# las columnas de las que hablan son las que hay.
echo
echo "════════ hoja-y-vestido ════════"
